...
const FontBoldCenter = "text-center font-bold text-white";
  ...
  return (
    <section className="bg-secondary font-serif text-white">
        <div>
            <div className={`${FontBoldCenter} items-center text-3xl sm:text-3xl md:text-5xl lg:text-7xl py-6`}>
                INSTRUCTIONS
            </div>
        </div>
        ...
        <div className="flex flex-wrap w-full">
            ...
            <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                <h2 className="font-medium title-font text-sm mb-1 tracking-wider">STEP 2</h2>
            ...
            <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                <h2 className="font-medium title-font text-sm mb-1 tracking-wider">STEP 3</h2>
            ...
            <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                <h2 className="font-medium title-font text-sm mb-1 tracking-wider">STEP 4</h2>
                <p className="leading-relaxed">VHS cornhole pop-up, try-hard 8-bit iceland helvetica. Kinfolk bespoke try-hard cliche palo santo offal.</p>
                </div>
            </div>
            ...
            <div className="flex relative">
                ...
                <div className="flex-grow pl-4">
                <h2 className="font-medium title-font text-sm mb-1 tracking-wider">FINISH</h2>
